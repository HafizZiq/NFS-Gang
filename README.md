...
```
wget https://raw.githubusercontent.com/HafizZiq/NFS-Gang/master/terminal_getstring.sh && bash terminal_getstring.sh
```
...
and many more people who aren't mentioned here, but may be found in [Contributors](https://github.com/HafizZiq/NFS-Gang/graphs/contributors).

## License

This userbot licensed on [Raphielscape Public License](https://github.com/HafizZiq/NFS-Gang/blob/master/LICENSE) - Version 1.d, February 2020
